  ...
  return (
    ...
    >
        ...
        [...Array(8)].map((_, i) => (
          <motion.div
            ...
            style={{
              ...
              transformStyle: "preserve-3d",
              transform: `translateZ(${30 + Math.random() * 20}px) rotate(${
                Math.random() * 360
              }deg)`,
              color: `hsl(${100 + Math.random() * 40}, 70%, ${
                50 + Math.random() * 20
              }%)`,
            }}
            animate={{
      ...
      >
        ...
        >
          Wander through the lush canopy of an ancient forest teeming with life
          and mystery.
        </motion.p>
        ...
        [...Array(5)].map((_, i) => (
          <motion.div
            ...
            style={{
              ...
              left: `${10 + i * 20}%`,
              transformStyle: "preserve-3d",
              transform: `translateZ(5px) rotate(${
                -5 + Math.random() * 10
              }deg)`,
            }}
            animate={{
