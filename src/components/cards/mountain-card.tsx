...
export function MountainCard() {
  ...
  const rotateX = isHovering ? (mousePosition.y / cardRef.current?.offsetHeight! - 0.5) * 20 : 0
  const rotateY = isHovering ? -(mousePosition.x / cardRef.current?.offsetWidth! - 0.5) * 20 : 0
    ...
    >
      ...
      >
        <img
          ...
          style={{
            filter: isHovering ? "brightness(0.7) contrast(1.2)" : "brightness(0.9)",
          }}
        />
      ...
      >
        ...
        >
          Discover the serenity of mountain landscapes and reconnect with nature's beauty.
        </motion.p>
