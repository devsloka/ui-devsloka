      ...
      <div className="container px-4 md:px-6 relative">
        ...
        <div className="relative min-h-[500px] md:min-h-[600px] lg:min-h-[700px]">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full bg-gradient-to-br from-primary/20 via-primary/10 to-transparent flex items-center justify-center"
          >
            <div className="w-48 h-48 md:w-64 md:h-64 lg:w-72 lg:h-72 rounded-full bg-background border border-border/50 shadow-lg flex items-center justify-center p-6 backdrop-blur-sm">
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex items-start gap-3 bg-background/80 backdrop-blur-sm border border-border/50 p-3 rounded-lg shadow-lg max-w-[200px]"
      >
        <div
          className={cn(
